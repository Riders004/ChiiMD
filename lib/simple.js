    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        chat: {
            get() {
                ...
                return this.conn.getJid(this.key?.remoteJidAlt?.endsWith('@s.whatsapp.net') ? this.key.remoteJidAlt : this.key?.remoteJid || (senderKeyDistributionMessage && senderKeyDistributionMessage !== 'status@broadcast'))
            }
        },
        isGroup: {
            get() {
